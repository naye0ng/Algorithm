...
- [x] 4615 : 오셀로 게임
- [x] 1240 : 단순 2진 암호코드
- [x] 1244 : BFS vs DFS, 중복된 연산을 제거하기 위해 dvisited[depth]의 값을 유일하게 유지
...
### 그래프의 기본과 탐색
- [x] 5247 : BFS : from collections import deque, popleft()
- [x] 5248 : 그룹 나누기(Union)

### 그래프의 최소 비용
- [x] 5249 : 최소 신장 트리 : 크루스칼 사용
- [ ] 5250 : 최소 비용 => 다익스트라, 힙으로 풀어보기, import heapq
- [x] 5251 : 다익스트라 : 보든 지점을 방문할 필요 없다.

## 모의 SW 역량테스트(시뮬레이션)
- [x] 4008 : 숫자 만들기 : python에서 -5//3 = -2가 나오므로, abs(-5)//3*(-1)로 나누기 처리 해줘야 한다.

- [ ] 5650 : 핀볼 게임 : 장애물의 방향설정을 전역에서 dictionary로 설정해두자 
- [x] 2117 : 홈 방범 서비스
- [ ] 2115 : 벌꿀채취 : 부분집합을 생각하자 >> 1개 선택하는 경우부터 여러개까지 선택이 가능하다.
- [x] 1952 : 수영장 : 분할정렬의 분할방식을 사용

- [ ] 2383 : 점심 식사시간 
- [x] 1953 : 탈주범 검거 : 다음에 이동할 방향대비 올 수 있는 블럭의 모양을 검사해야 한다.
- [x] 2112 : 보호필름 : powerset을 이용하여 배열값 변경!